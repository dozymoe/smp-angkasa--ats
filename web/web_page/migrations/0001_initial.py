    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary_id', models.TextField(blank=True, verbose_name='Summary')),
                ...
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='created_webpages', to=settings.AUTH_USER_MODEL)),
                ('published_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='published_webpages', to=settings.AUTH_USER_MODEL)),
            ],
            options={
